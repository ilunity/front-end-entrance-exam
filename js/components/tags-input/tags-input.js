...
const generateTemplateClone = (features) => {
    ...
    template.innerHTML = `
        ...
        <div class="feature-input">
            <custom-input name="tags"></custom-input>
            <button is="custom-button">Добавить</button>
        </div>
        <ul class="experience-item__featured-points featured-points">
...
class FeaturesInput extends HTMLElement {
    ...
    render() {
        console.log('render features-input')
